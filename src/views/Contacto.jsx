            ...
            <div className="lg:col-span-7 order-1 lg:order-2" data-aos="fade-left">
              <div className="relative rounded-2xl bg-gradient-to-br from-[#D94B45]/20 via-white to-[#9BA6A1]/20 p-[1px]">
                <div className="relative rounded-2xl bg-white border border-[#E7EBEA] shadow-md p-8 sm:p-10 overflow-hidden">
                  {/* blobs decorativos internos */}
                  <div className="pointer-events-none absolute -top-24 -right-16 w-72 h-72 rounded-full bg-[#D94B45]/10 blur-3xl" />
                  ...
                  <div className="mt-6 space-y-5 relative z-10">
                    <div className="relative rounded-xl border border-[#E7EBEA] p-5 shadow-sm bg-gradient-to-br from-[#D94B45]/5 to-white overflow-hidden">
                      ...
                      <h3 className="flex items-center gap-2 font-semibold text-gray-900">
                        <svg className="h-5 w-5 text-[#D94B45]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M2 6.5A2.5 2.5 0 014.5 4h15A2.5 2.5 0 0122 6.5v11A2.5 2.5 0 0119.5 20h-15A2.5 2.5 0 012 17.5v-11zm2.2-.4l7.3 4.86a1 1 0 001.1 0l7.2-4.86A1.5 1.5 0 0019.5 5h-15c-.33 0-.63.04-.9.1z"/></svg>
                        Correo electrónico
                      </h3>
