...
const ServicesInteractive = () => {
  ...
  <div className="rounded-3xl bg-white border-2 border-[#D94B45]/20 p-10 shadow-xl min-h-[480px] flex flex-col" data-aos="fade-right">
          ...
          {/* Nota "Incluido en todos los planes" eliminada a pedido */}
        </div>
            ...
            <div className="relative rounded-3xl bg-white border-2 border-[#D94B45]/30 shadow-lg overflow-hidden py-4 px-6 sm:py-5 sm:px-8" data-aos="fade-up" data-aos-delay="150">
              ...
              <div className="flex animate-scroll min-w-max">
                ...
                {[
                  ...
                  { value: '+900', label: 'Instalaciones realizada en 15 paises', icon: 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z' }
                ].map((stat, i) => (
                  <div 
                    key={`first-${i}`}
